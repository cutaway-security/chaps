...
| Field | Value |
|-------|-------|
| Hostname | WIN-7O1NOPISE6L |
| Start Time | Monday 04/13/2026 22:04:27 -07:00 |
| PS Version | 5 |
...
[*] Microsoft Windows Server 2016 Standard, 10.0.14393, 14393, 64-bit, WORKGROUP
[*] Windows Version: Microsoft Windows NT 10.0.14393.0
[*] Windows Default Path for administrator : C:\Program Files\OpenSSH\;C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Windows\System32\WindowsPowerShell\v1.0\;C:\Users\Administrator\AppData\Local\Microsoft\WindowsApps;
...
[*] Get-ProcessMitigation not available. Cannot check Exploit Protection settings.
...
[+] Sysmon service is running: Sysmon (Sysmon)
...
[-] Windows Defender Real-Time Protection is not enabled.
[+] Windows Defender signatures are 1 day(s) old.
...
[*] Account in local Administrator group: WIN-7O1NOPISE6L\Administrator
...
[*] Host network interface assigned: 192.168.100.14
[-] Host IPv6 network interface assigned (gwmi): fe80::558f:66a5:96be:da00
...
[*] Listening TCP ports:
[*]   :::22 (PID: 1728, Process: sshd)
[*]   :::135 (PID: 696, Process: svchost)
[*]   192.168.100.14:139 (PID: 4, Process: System)
[*]   :::445 (PID: 4, Process: System)
[*]   :::5985 (PID: 4, Process: System)
[*]   :::47001 (PID: 4, Process: System)
[*]   0.0.0.0:49664 (PID: 424, Process: wininit)
[*]   0.0.0.0:49665 (PID: 936, Process: svchost)
[*]   0.0.0.0:49666 (PID: 896, Process: svchost)
[*]   :::49667 (PID: 1560, Process: spoolsv)
[*]   :::49668 (PID: 548, Process: services)
[*]   :::49681 (PID: 556, Process: lsass)
[*] Established TCP connections:
[*]   192.168.100.14:49682 -> 104.208.203.89:443 (PID: 896, Process: svchost)
[*]   192.168.100.14:22 -> 192.168.1.24:55114 (PID: 1728, Process: sshd)
...
[+] Current PowerShell Version: 5.1.14393.693
[*] PowerShell Engine Version: 2.0
[*] PowerShell 3+ Engine Version: 5.1.14393.0
[+] .NET Framework greater than 3.0 installed: 4.6.01586
[+] .NET Framework greater than 3.0 installed: 4.6.01586
[+] .NET Framework greater than 3.0 installed: 4.6.01586
[+] .NET Framework greater than 3.0 installed: 4.6.01586
...
**chaps_PSv2 completed** -- Stop Time: Monday 04/13/2026 22:04:32 -07:00
